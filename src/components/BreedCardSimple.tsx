...
interface BreedCardSimpleProps {
    id: string;
    name: string;
    subtitle: string;
    imageSrc: string;
...
const BreedCardSimple = ({ id, name, subtitle, imageSrc, imageAlt, description, details }: BreedCardSimpleProps) => {
    return (
        <div id={id} className="breed-card animate-fade-in">
...
export default BreedCardSimple;
